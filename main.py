...
file_load_label.grid(row=0, column=1)
...
file_robot_button.grid(row=1, column=0)
file_robot_label = tk.Label(window, text=robo_path, fg="blue")
file_robot_label.grid(row=1, column=1)
...
folder_testresult_button.grid(row=2, column=0)
folder_testresult_label = tk.Label(window, text=test_result_path, fg="blue")
folder_testresult_label.grid(row=2, column=1)
...
folder_config_button.grid(row=3, column=0)
folder_config_label = tk.Label(window, text=vlc_itc_path, fg="blue")
folder_config_label.grid(row=3, column=1)
...
folder_originimage_button.grid(row=4, column=0)
